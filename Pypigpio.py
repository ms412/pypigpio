...
from src.gpio_backend import DEFAULT_HW_REVISION, GpiodBackend
from src.socket_server import PigpioSocketServer
...
class Pypigpio(object):
    ...
    def start_server(self):
        self._server = PigpioSocketServer(
    ...
    def start(self):
        self.read_config()
        self.start_loggin()
        self._logger.info("Starting Pypigpio server...{version} (HW Rev: {hw_rev})".format(version=__VERSION__, hw_rev=hex(self._hw_revision)))
